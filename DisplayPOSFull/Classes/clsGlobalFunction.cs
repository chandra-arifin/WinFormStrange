...
namespace ZFame
{
	...
	public class GlobalFunction
	{
        ...
        public void SetLabelFontSize(float newSize, params System.Windows.Forms.Label[] labels)
        {
            foreach (System.Windows.Forms.Label label in labels)
                label.Font = new System.Drawing.Font(label.Font.Name, newSize);
        }

        public void SetButtonFontSize(float newSize, params System.Windows.Forms.Button[] buttons)
        {
            foreach (System.Windows.Forms.Button button in buttons)
                button.Font = new System.Drawing.Font(button.Font.Name, newSize);
        }

        public void SetTextboxFontSize(float newSize, params System.Windows.Forms.TextBox[] textboxes)
        {
            foreach (System.Windows.Forms.TextBox textbox in textboxes)
                textbox.Font = new System.Drawing.Font(textbox.Font.Name, newSize);
        }
